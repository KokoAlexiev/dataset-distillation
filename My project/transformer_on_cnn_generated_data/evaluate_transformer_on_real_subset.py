...
train_data = datasets.MNIST('./data', train=True, downloasubset_indices = torch.randperm(len(train_data))[:args.total_images]
subset_indices = torch.randperm(len(train_data))[:args.total_images]
...
row = {
    ...
    "Images_Per_Class": "varies",  # assuming 10 classes
