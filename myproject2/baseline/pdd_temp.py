...
if __name__ == "__main__":
    ...
    # 3) Visualize and Save Distilled Sets
    print("\n🖼️ Visualizing distilled images...")
    
    # Create combined tensors for visualization
    ...
    imgs_np = all_imgs.numpy()
    labels_np = all_lbls.numpy()
    
    num_classes = 10
    # Calculate how many images per class we have 
    # (might not be perfectly balanced depending on the distillation)
    images_per_class = min(5, max(1, len(all_imgs) // num_classes))  # Show max 5 per class
